<%@ page language="java" contentType="text/html; charset=UTF-8"
   ...
   <ul class="nav nav-sidebar"> 
		...
		<li class="active"><a href="${pageContextPath.${pageContextPath.request.getContextPath}}/alluser">전체 사용자</a></li>
		<li class="active"><a href="${pageContextPath.${pageContextPath.request.getContextPath}}/allEmp">전체 직원</a></li>
		<li class="active"><a href="${pageContextPath.${pageContextPath.request.getContextPath}}/pagingUser?page=1&pageSize=5">사용자 페이징 리스트</a></li>
		<li class="active"><a href="${pageContextPath.${pageContextPath.request.getContextPath}}/registUser?userid=">사용자 등록</a></li>
		<%--
