...
<link rel="stylesheet" type="text/css" media="all" href="${pageContextPath.request.getContextPath}();/error/404/js/impromptu/css.css"/>
<link rel="stylesheet" type="text/css" media="all" href="${pageContextPath.request.getContextPath}();/error/404/style.css" />


<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.6.4/jquery.min.js"></script>
<script type="text/javascript" src="${pageContextPath.request.getContextPath}/error/404/js/impromptu/jquery-impromptu.js"></script>
<script type="text/javascript" src="${pageContextPath.request.getContextPath}/error/404/js/jquery-global.js"></script>
