...
<!--     Bootstrap core CSS -->
<%--     <link href="${pageContextPath.${pageContextPath.request.getContextPath}}/css/bootstrap.min.css" rel="stylesheet"> --%>
    ...
    <link href="${pageContextPath.${pageContextPath.request.getContextPath}}/css/signin.css" rel="stylesheet">
...
//     	}
  ...
  <body>
    ...
    <div class="container">
      ...
      <form id="frm" class="form-signin" action="${pageContextPath.${pageContextPath.request.getContextPath}}/loginController" method="get">
